                                      ...
                                      <tbody>
                                        <tr>
                                          <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                            <h1 class="h3" style="padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 28px; line-height: 33.6px; margin: 0;" align="left">GDE Conference Registration</h1>
                                            ...
                                            <h5 class="text-teal-700" style="color: #13795B; padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; margin: 0;" align="left">Dear <?= $name ?>,</h5>
                                            ...
                                            <div class="space-y-3">
                                              <p class="text-gray-700" style="line-height: 24px; font-size: 16px; color: #4A5568; width: 100%; margin: 0;" align="left">
                                                Thank you for registering for the Dennis Gabor Digital Horizons Week as a <strong><?= $registration_type === 'speaker' ? 'Speaker' : 'Attendee' ?></strong>.
                                              </p>
                                              ...
                                              <p class="text-gray-700" style="line-height: 24px; font-size: 16px; color: #4A5568; width: 100%; margin: 0;" align="left">
                                                <strong>As a speaker, please upload your abstract(s) using the following link(s):</strong>
                                              </p>
                                              <table class="s-3 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                                <tbody>
                                                  <tr>
                                              ...
                                              <ul style="padding-left: 20px;">
                                                ...
                                                <li class="text-gray-700" style="line-height: 24px; font-size: 16px; color: #4A5568;">
                                                  <strong><?= strtoupper($key) ?> Conference:</strong> 
