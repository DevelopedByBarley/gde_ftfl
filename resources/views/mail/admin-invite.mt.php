																			...
																			<tbody>
																				<tr>
																					<td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
																						<h1 class="h3" style="padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 28px; line-height: 33.6px; margin: 0;" align="left">Admin meghívó</h1>
																						...
																						<div class="space-y-3">
																							<p class="text-gray-700" style="line-height: 24px; font-size: 16px; color: #4A5568; width: 100%; margin: 0;" align="left">
																								Meghívót kapott, hogy csatlakozzon adminisztrátorként a Budafok–Tétény jubileumi oldalhoz.
																							</p>
																							...
																							<p class="text-gray-700" style="line-height: 24px; font-size: 16px; color: #4A5568; width: 100%; margin: 0;" align="left">
																								Kérjük, erősítse meg a meghívást az alábbi gombra kattintva, majd állítsa be jelszavát:
																							</p>
																							<table class="s-3 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
																								<tbody>
																									<tr>
																							...
																							<table role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
																								<tbody>
																									<tr>
																										<td align="center">
																											<a href="<?= $invite_url ?>" style="display: inline-block; padding: 12px 20px; background-color: #13795B; color: #ffffff; border-radius: 6px; font-weight: 600;">Meghívás elfogadása</a>
																										</td>
																									</tr>
																								</tbody>
																							</table>
																							...
																							<p class="text-gray-700" style="line-height: 24px; font-size: 16px; color: #4A5568; width: 100%; margin: 0;" align="left">
																								...
																								<a style="color: blue; font-weight: bolder" href="<?= $invite_url ?>"><?= $invite_url ?></a>
																							</p>
																							<table class="s-3 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
																								<tbody>
																									<tr>
																							...
																							<p class="text-gray-700" style="line-height: 24px; font-size: 16px; color: #4A5568; width: 100%; margin: 0;" align="left">
																								A meghívó <?= 48 ?> órán belül lejár. Ha nem Ön kérte, egyszerűen hagyja figyelmen kívül ezt az üzenetet.
																							</p>
																						</div>
																						<table class="s-5 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
																							<tbody>
																						...
																						<p class="text-gray-600" style="line-height: 24px; font-size: 16px; color: #718096; width: 100%; margin: 0;" align="left">Üdvözlettel:<br>
 <strong>Budafok–Tétény Jubileumi Oldal csapata</strong> </p>
																					</td>
																				</tr>
																			</tbody>
																		</table>
